%%
% This function computes the next iterate of the algorithm
...
%  -- XX_data:  Normalize Data dot data labels
%  -- d:  Number of data points
% 
% Output:
%  -- outer_inner:   Next iterate approximate solution

function [out_inner] = Nes_log_Inner(y,n,tau,M,N,L3,gamma,options,XXdata,d)
